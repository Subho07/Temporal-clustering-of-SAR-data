...
If ![mfp](https://latex.codecogs.com/svg.latex?\theta_{\text{FP}}) and ![mfp](https://latex.codecogs.com/svg.latex?H_{\text{FP}}) are already in the parent folder then you may use the 'unsupervised_clustering_FP.py' to compute the clustered image. If ![mfp](https://latex.codecogs.com/svg.latex?\theta_{\text{CP}}), ![mfp](https://latex.codecogs.com/svg.latex?H_{\text{CP}}), are already in the parent folder then you may use the 'unsupervised_clustering_CP.py' to compute the clustered image.
